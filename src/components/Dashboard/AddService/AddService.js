...
const AddService = ({ editService, restrictPermission, setEditService }) => {
    ...
    const onSubmit = async data => {
        ...
        if (!editService || (editService && data.image[0])) {
            ...
            imageData.set('key', '30002a095cd46686e7cf9f00957005a5');
        ...
        if (editService) {
            ...
            axios.patch(`https://cardoctor.herokuapp.com/update/${editService._id}`, serviceInfo)
                .then(res => {
                    toast.dismiss(loading);
                    if (res.data) {
        ...
        axios.post('https://cardoctor.herokuapp.com/addService', serviceInfo)
            .then(res => {
                toast.dismiss(loading);
                if (res.data) {
