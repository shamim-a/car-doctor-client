                    ...
                    <Col md={12} lg={4}>
                        <div className="dk-footer-box-info">
                            <Link to="/" onClick={scrollHandler} className="footer-logo">
                                ...
                                <h3 className="text-center text-white mb-0">Car Doctor</h3>
                            </Link>
                            ...
                            <Col md={6}>
                                <div className="contact-us">
                                    ...
                                    <div className="contact-info">
                                        <h3>Gazipur, Bangladesh</h3>
                                        <p>BIDC Bazaar Road, Gazipur - 1707</p>
                                    </div>
                                </div>
                            </Col>
                            <Col md={6}>
                                <div className="contact-us contact-us-last">
                                    ...
                                    <div className="contact-info">
                                        <h3>+880- 1642 467 332</h3>
                                        <p>Call for any Queries</p>
                                    </div>
                                </div>
                            </Col>
                        </Row>
                ...
                <Container>
                    <Row>
                        <Col md={6} className="order-2 order-md-1">
                            <span>Copyright © {new Date().getFullYear()}, <span style= {{color: '#00EFD0'}}>Car Doctor</span> All Rights Reserved</span>
                        </Col>
